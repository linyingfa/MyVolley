...
public class NetworkResponse {
    ...
    /**
     * Creates a new network response. 响应
     *
    ...
    public NetworkResponse(byte[] data) {
        this(HttpURLConnection.HTTP_OK, data,/* notModified= */ false,/* networkTimeMs= */ 0, Collections.<Header>emptyList());
    }
    ...
    public NetworkResponse(byte[] data, Map<String, String> headers) {
        this(HttpURLConnection.HTTP_OK, data, headers,/* notModified= */ false,/* networkTimeMs= */ 0);
    }
